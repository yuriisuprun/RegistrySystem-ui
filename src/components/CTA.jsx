    ...
    <section ref={sectionRef} className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-30 container-max px-4 sm:px-6 lg:px-8">
        <div className={`text-center transition-all duration-1000 ${
          ...
          {/* Subtitle */}
          <p className={`text-xl lg:text-2xl text-primary-dark/80 mb-10 max-w-3xl mx-auto transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            {t('cta.subtitle')}
          </p>
          ...
          {/* Contact Info */}
          <div className={`mt-12 flex flex-col sm:flex-row justify-center items-center gap-8 transition-all duration-1000 delay-700 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
          ...
          <div className={`mt-8 transition-all duration-1000 delay-900 ${
            ...
            <div className="inline-flex items-center bg-primary-dark/20 rounded-full px-6 py-2">
              ...
              <span className="text-primary-dark font-medium">Consulenza gratuita entro 24 ore</span>
            </div>
          </div>
        </div>
      </div>
