  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-primary-gold rounded-full animate-float opacity-40" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-primary-gold rounded-full animate-float opacity-50" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative z-30 container-max px-4 sm:px-6 lg:px-8 text-center">
        <div className={`transition-all duration-1000 ${
          ...
          {/* Subtitle */}
          <p className={`text-lg sm:text-xl lg:text-2xl text-primary-gray mb-8 max-w-4xl mx-auto leading-relaxed transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            {t('hero.subtitle')}
          </p>
          ...
          <div className={`mt-12 transition-all duration-1000 delay-700 ${
            ...
            <p className="text-primary-gray text-sm mt-2">Guarda il nostro video di presentazione</p>
          </div>
        </div>
      </div>
